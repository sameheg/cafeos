    ...
    if ($('table#product_sell_report_table').length == 1) {
        ...
        product_sell_report = $('table#product_sell_report_table').DataTable({
            ...
            columns: [
                ...
                { data: 'contact_id', name: 'c.contact_id', className: 'd-none d-sm-table-cell' },
                { data: 'contact_no', name: 'c.mobile', className: 'd-none d-sm-table-cell' },
                { data: 'invoice_no', name: 't.invoice_no', className: 'd-none d-sm-table-cell' },
                { data: 'transaction_date', name: 't.transaction_date' },
                { data: 'sell_qty', name: 'transaction_sell_lines.quantity' },
                { data: 'unit_price', name: 'transaction_sell_lines.unit_price_before_discount' },
                { data: 'discount_amount', name: 'transaction_sell_lines.line_discount_amount', className: 'd-none d-md-table-cell' },
                { data: 'tax', name: 'tax_rates.name', className: 'd-none d-md-table-cell' },
                { data: 'unit_sale_price', name: 'transaction_sell_lines.unit_price_inc_tax' },
                { data: 'subtotal', name: 'subtotal', searchable: false },
                { data: 'payment_methods', name: 'payment_methods', searchable: false, className: 'd-none d-sm-table-cell' },
            ],
            fnDrawCallback: function(oSettings) {
                $('#footer_subtotal').text(
