...
class BusinessController extends Controller
{
    ...
    */
    ...
    public function getRegister()
    {
        ...
        return view('business.register', $data);
    }
    ...
    public function postRegister(Request $request)
    {
        ...
        return $this->registrationService->registerBusiness($request);
    }
    ...
    {
        $available = $this->registrationService->checkUsername(
            $request->input('username'),
            $request->input('username_ext')
        );
    ...
    public function getBusinessSettings()
    {
        ...
        $theme_colors = $this->themeService->getThemeColors();

        $mail_drivers = $this->mailService->getMailDrivers();
    ...
    {
        $exists = $this->mailService->checkEmail(
            $request->input('email'),
    ...
    public function testEmailConfiguration(Request $request)
    {
        ...
        return $this->mailService->testEmailConfiguration($email_settings);
    }
